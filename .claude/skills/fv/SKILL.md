---
name: fv
description: fvプロジェクト用のGitHub/Gitワークフローコマンド。GitHub Issueの作成、featureブランチの作成、コミットの作成、プルリクエストの作成を行う。ユーザーが「/fv issue」「/fv branch」「/fv commit」「/fv pr」と入力した場合、またはfvプロジェクトでissue作成、ブランチ作成、コミット、PR作成を依頼された場合にこのスキルを使用すること。
---
